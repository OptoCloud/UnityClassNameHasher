...
// Source: https://github.com/AndreyRusyaev/acryptohashnet

namespace UnityClassNameHasher.Crypto;
...
public sealed class MD4 : BlockHashAlgorithm
{
    ...
    private ulong processedLength = 0;
    ...
    {
        processedLength += (ulong)BlockSize << 3; // * 8
    ...
    {
        processedLength += (ulong)length << 3; // * 8

        byte[] messageLength = BitConverter.GetBytes(processedLength);
